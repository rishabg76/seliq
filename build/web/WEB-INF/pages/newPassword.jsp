...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Project1/css/password_reset.css">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <main>
                            ...
                            <div class="body_section">
                                ...
                                <form class="f_container" action="/Project1/fc/ab?type=model&page=Update&email=<%=request.getParameter("email").toString()%>" method="POST">
